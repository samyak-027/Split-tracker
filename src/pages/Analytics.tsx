  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-base-content/60 text-sm">Visualize your spending patterns.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-base-100 p-6 rounded-2xl shadow-sm border border-base-300">
              ...
              {isLoading ? (
                  <div className="h-64 flex items-center justify-center text-base-content/60">Loading chart...</div>
              ) : categoryData.length === 0 ? (
                  <div className="h-64 flex items-center justify-center text-base-content/60">No data available</div>
              ) : (
                  <div className="h-64">
